...
Public Class modelwisestockreport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "modelwisestockreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmodelwisestockreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As modelwisestockreport = New modelwisestockreport
        rpt.Site = Me.Site
        Return rpt
    End Function
